...
import AdrianWulf from "../assets/Adrian_Wulf.jpg";
import NicolausKastner from "../assets/Nicolaus_Kastner.jpg";
      ...
      <div className="aboutRight">
        <div className="aboutContainer1">
          ...
          <p>
            ...
            absolvierte zunächst an der Friedrich-Alexander Universität in
            Nürnberg seinen Bachelor in Wirtschaftswissenschaften und arbeitete
            anschließend als “Marketing Consultant” für einen Zulieferer von
            BMW. Nicolaus Kastner stieg in die Fußstapfen seiner Eltern und
            begann nach dem schulischen Abschluss eine Ausbildung zum Redakteur
            und arbeitet über die Jahre für verschiedene Sender wie Kabel1, Pro7
            und DMAX.
          </p>
        </div>
        <div className="aboutContainer2">
          ...
          <p>
            ...
            wir! C-NOW vermittelt dir den passenden Editor für deine gewünschten
            Ansprüche! Verschwende keine Zeit, lass es die Profis machen!
          </p>
        </div>
      </div>
    </div>
